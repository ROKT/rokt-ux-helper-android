...
@Serializable
data class AccessibilityGroupedModel<Child>(val child: Child)

@Serializable
data class ThemeUrl(val light: String, val dark: String? = null)
...
@Serializable
data class ThemeColor(val light: String, val dark: String? = null)
...
@Serializable
data class BasicStateStylingBlock<StyleProperties>(
    val default: StyleProperties,
    val pressed: StyleProperties? = null,
    val hovered: StyleProperties? = null,
    val focussed: StyleProperties? = null,
    val disabled: StyleProperties? = null,
)
...
@Serializable
data class SpacingStylingProperties(val padding: String? = null, val margin: String? = null, val offset: String? = null)
...
@Serializable
data class BasicTextElements(val own: List<BasicStateStylingBlock<BasicTextStyle>>)
...
@Serializable
data class BasicTextTransitions(val own: BasicTextStyle? = null)
...
@Serializable
data class BottomSheetTransitions(val own: BottomSheetStyles? = null, val wrapper: BottomSheetWrapperStyles? = null)
...
@Serializable
data class BreakpointPredicate(val condition: OrderableWhenCondition, val value: String)

@Serializable
data class StatelessStylingBlock<StyleProperties>(val default: StyleProperties)
...
@Serializable
data class CarouselDistributionElements(val own: List<StatelessStylingBlock<CarouselDistributionStyles>>)
...
data class CarouselDistributionModel<Predicates>(
    ...
    val styles:
    LayoutStyle<CarouselDistributionElements, ConditionalStyleTransition<CarouselDistributionTransitions, Predicates>>? = null,
)

@Serializable
data class CarouselDistributionTransitions(val own: CarouselDistributionStyles? = null)
...
@Serializable
data class CatalogResponseButtonElements(val own: List<BasicStateStylingBlock<CatalogResponseButtonStyles>>)

@Serializable
data class CatalogResponseButtonModel<Children, Predicates>(
    val a11y_label: String? = null,
    val styles:
    LayoutStyle<CatalogResponseButtonElements, ConditionalStyleTransition<CatalogResponseButtonTransitions, Predicates>>? = null,
    val children: List<Children>,
)

@Serializable
data class CatalogResponseButtonTransitions(val own: CatalogResponseButtonStyles? = null)
...
@Serializable
data class CatalogStackedCollectionElements(val own: List<StatelessStylingBlock<CatalogStackedCollectionStyles>>)

@Serializable
data class CatalogStackedCollectionModel<NodeTemplate, Predicates>(
    val styles:
    LayoutStyle<CatalogStackedCollectionElements, ConditionalStyleTransition<CatalogStackedCollectionTransitions, Predicates>>? = null,
    val template: NodeTemplate,
)

@Serializable
data class CatalogStackedCollectionTransitions(val own: CatalogStackedCollectionStyles? = null)
...
@Serializable
data class CloseButtonElements(val own: List<BasicStateStylingBlock<CloseButtonStyles>>)
...
@Serializable
data class CloseButtonTransitions(val own: CloseButtonStyles? = null)
...
@Serializable
data class ColumnElements(val own: List<BasicStateStylingBlock<ColumnStyle>>)
...
@Serializable
data class ColumnTransitions(val own: ColumnStyle? = null)
...
@Serializable
data class CreativeCopyPredicate(val condition: ExistenceWhenCondition, val value: String)
...
@Serializable
data class CreativeResponseElements(val own: List<BasicStateStylingBlock<CreativeResponseStyles>>)
...
data class CreativeResponseModel<Children, Predicates>(
    ...
    val styles:
    LayoutStyle<CreativeResponseElements, ConditionalStyleTransition<CreativeResponseTransitions, Predicates>>? =
        null,
...
@Serializable
data class CreativeResponseTransitions(val own: CreativeResponseStyles? = null)

@Serializable
data class CustomStatePredicate(val key: String, val condition: OrderableWhenCondition, val value: Int)
...
@Serializable
data class DarkModePredicate(val condition: EqualityWhenCondition, val value: Boolean)
...
@Serializable
data class DataIconElements(val own: List<BasicStateStylingBlock<DataIconStyles>>)
...
@Serializable
data class DataIconTransitions(val own: DataIconStyles? = null)

@Serializable
data class DataImageCarouselStyles(
    val container: ContainerStylingProperties? = null,
    val background: BackgroundStylingProperties? = null,
    val border: BorderStylingProperties? = null,
    val dimension: DimensionStylingProperties? = null,
...
@Serializable
data class DataImageCarouselIndicatorStyles(
    val container: ContainerStylingProperties? = null,
    val background: BackgroundStylingProperties? = null,
    val border: BorderStylingProperties? = null,
    val dimension: DimensionStylingProperties? = null,
...
@Serializable
data class DataImageCarouselElements(
    val own: List<BasicStateStylingBlock<DataImageCarouselStyles>>,
    val indicator: List<BasicStateStylingBlock<DataImageCarouselIndicatorStyles>>? = null,
    val activeIndicator: List<BasicStateStylingBlock<DataImageCarouselIndicatorStyles>>? = null,
    val seenIndicator: List<BasicStateStylingBlock<DataImageCarouselIndicatorStyles>>? = null,
    val progressIndicatorContainer: List<BasicStateStylingBlock<DataImageCarouselIndicatorStyles>>? = null,
)

@Serializable
data class DataImageCarouselModel<Predicates>(
    val styles:
    LayoutStyle<DataImageCarouselElements, ConditionalStyleTransition<DataImageCarouselTransitions, Predicates>>? = null,
    val imageKey: String,
    val duration: Int,
...
@Serializable
data class DataImageCarouselTransitions(
    val own: DataImageCarouselStyles? = null,
    val indicator: DataImageCarouselIndicatorStyles? = null,
    val activeIndicator: DataImageCarouselIndicatorStyles? = null,
    val seenIndicator: DataImageCarouselIndicatorStyles? = null,
    val progressIndicatorContainer: DataImageCarouselIndicatorStyles? = null,
)
...
@Serializable
data class DataImageElements(val own: List<BasicStateStylingBlock<DataImageStyles>>)
...
@Serializable
data class DataImageTransitions(val own: DataImageStyles? = null)
...
@Serializable
data class FadeInOutTransitionSettings(val duration: Int)

@Serializable
data class FadeInTransitionSettings(val duration: Int)

@Serializable
data class FadeOutTransitionSettings(val duration: Int)
...
@Serializable
data class GroupedDistributionElements(val own: List<StatelessStylingBlock<GroupedDistributionStyles>>)
...
data class GroupedDistributionModel<Predicates>(
    ...
    val styles:
    LayoutStyle<GroupedDistributionElements, ConditionalStyleTransition<GroupedDistributionTransitions, Predicates>>? = null,
)

@Serializable
data class GroupedDistributionTransitions(val own: GroupedDistributionStyles? = null)
...
@Serializable
data class InLineTextStyle(val text: InlineTextStylingProperties)
...
@Serializable
data class InlineContainerStylingProperties(
    val shadow: Shadow? = null,
    val blur: Float? = null,
    val opacity: Float? = null,
)
...
@Serializable
data class LayoutSettings(val closeOnComplete: Boolean? = null)
...
@Serializable
data class OneByOneDistributionElements(val own: List<StatelessStylingBlock<OneByOneDistributionStyles>>)

@Serializable
data class OneByOneDistributionModel<Predicates>(
    val styles:
    LayoutStyle<OneByOneDistributionElements, ConditionalStyleTransition<OneByOneDistributionTransitions, Predicates>>? = null,
    val transition: Transition,
)

@Serializable
data class OneByOneDistributionTransitions(val own: OneByOneDistributionStyles? = null)
...
@Serializable
data class OverlayTransitions(val own: OverlayStyles? = null, val wrapper: OverlayWrapperStyles? = null)

@Serializable
data class PositionPredicate(val condition: OrderableWhenCondition, val value: String)
...
@Serializable
data class ProgressControlElements(val own: List<BasicStateStylingBlock<ProgressControlStyle>>)
...
data class ProgressControlModel<Children, Predicates>(
    val styles:
    LayoutStyle<ProgressControlElements, ConditionalStyleTransition<ProgressControlTransitions, Predicates>>? = null,
    val direction: ProgressionDirection,
    val children: List<Children>,
)

@Serializable
data class ProgressControlTransitions(val own: ProgressControlStyle? = null)
...
data class ProgressIndicatorModel<Predicates>(
    val styles:
    LayoutStyle<ProgressIndicatorElements, ConditionalStyleTransition<ProgressIndicatorTransitions, Predicates>>? = null,
...
@Serializable
data class ProgressionPredicate(val condition: OrderableWhenCondition, val value: String)
...
@Serializable
data class RichTextTransitions(val own: RichTextStyle? = null, val link: InLineTextStyle? = null)
...
@Serializable
data class RowElements(val own: List<BasicStateStylingBlock<RowStyle>>)
...
@Serializable
data class RowTransitions(val own: RowStyle? = null)
...
@Serializable
data class ScrollableColumnElements(val own: List<BasicStateStylingBlock<ScrollableColumnStyle>>)

@Serializable
data class ScrollableColumnModel<Children, Predicates>(
    val styles:
    LayoutStyle<ScrollableColumnElements, ConditionalStyleTransition<ScrollableColumnTransitions, Predicates>>? =
        null,
    val children: List<Children>,
)

@Serializable
data class ScrollableColumnTransitions(val own: ScrollableColumnStyle? = null)
...
@Serializable
data class ScrollableRowElements(val own: List<BasicStateStylingBlock<ScrollableRowStyle>>)
...
@Serializable
data class ScrollableRowTransitions(val own: ScrollableRowStyle? = null)
...
@Serializable
data class SlideStateTriggerLabel(val value: String? = null)

@Serializable
data class SlideStateTriggerThumb(val icon: String? = null)

@Serializable
data class SlideStateTriggerModel<Predicates>(
    val styles:
    LayoutStyle<SlideStateTriggerElements, ConditionalStyleTransition<SlideStateTriggerTransitions, Predicates>>? = null,
...
@Serializable
data class StaticBooleanPredicate(val condition: BooleanWhenCondition, val value: Boolean)
...
@Serializable
data class StaticIconElements(val own: List<BasicStateStylingBlock<StaticIconStyles>>)
...
@Serializable
data class StaticIconTransitions(val own: StaticIconStyles? = null)
...
@Serializable
data class StaticImageElements(val own: List<BasicStateStylingBlock<StaticImageStyles>>)

@Serializable
data class StaticImageUrl(val light: String, val dark: String? = null)
...
@Serializable
data class StaticImageTransitions(val own: StaticImageStyles? = null)
...
@Serializable
data class StaticLinkElements(val own: List<BasicStateStylingBlock<StaticLinkStyles>>)
...
@Serializable
data class StaticLinkTransitions(val own: StaticLinkStyles? = null)

@Serializable
data class StaticStringPredicate(val input: String, val condition: EqualityWhenCondition, val value: String)

@Serializable
data class TimerStateTriggerModel(val customStateKey: String, val delay: Float? = null, val value: Float? = null)
...
@Serializable
data class ToggleButtonStateTriggerElements(val own: List<BasicStateStylingBlock<ToggleButtonStateTriggerStyle>>)

@Serializable
data class ToggleButtonStateTriggerModel<Children, Predicates>(
    val styles:
    LayoutStyle<ToggleButtonStateTriggerElements, ConditionalStyleTransition<ToggleButtonStateTriggerTransitions, Predicates>>? = null,
    val children: List<Children>,
    val customStateKey: String,
)

@Serializable
data class ToggleButtonStateTriggerTransitions(val own: ToggleButtonStateTriggerStyle? = null)
...
@Serializable
data class WhenTransition(val inTransition: List<InTransition>? = null, val outTransition: List<OutTransition>? = null)
...
@Serializable
data class ZStackElements(val own: List<BasicStateStylingBlock<ZStackStyle>>)
...
@Serializable
data class ZStackTransitions(val own: ZStackStyle? = null)
...
sealed class CatalogStackedCollectionTemplateNodeChildren {
    ...
    data class ToggleButtonStateTrigger(
        val node: ToggleButtonStateTriggerModel<LayoutVariantNonInteractableChildren, LayoutVariantWhenPredicate>,
    ) : CatalogStackedCollectionTemplateNodeChildren()

    @Serializable
    @SerialName("CatalogResponseButton")
    data class CatalogResponseButton(
        val node: CatalogResponseButtonModel<LayoutVariantNonInteractableChildren, LayoutVariantWhenPredicate>,
    ) : CatalogStackedCollectionTemplateNodeChildren()

    @Serializable
    @SerialName("TimerStateTrigger")
    data class TimerStateTrigger(val node: TimerStateTriggerModel) : CatalogStackedCollectionTemplateNodeChildren()
}
...
sealed class LayoutSchemaModel {
    ...
    @Serializable
    @SerialName("DataImageCarousel")
    data class DataImageCarousel(val node: DataImageCarouselModel<WhenPredicate>) : LayoutSchemaModel()
    ...
    @Serializable
    @SerialName("TimerStateTrigger")
    data class TimerStateTrigger(val node: TimerStateTriggerModel) : LayoutSchemaModel()

    @Serializable
    @SerialName("CatalogStackedCollection")
    data class CatalogStackedCollection(
        val node: CatalogStackedCollectionModel<CatalogStackedCollectionLayoutSchemaTemplateNode, WhenPredicate>,
    ) : LayoutSchemaModel()
...
sealed class LayoutVariantChildren {
    ...
    data class ScrollableColumn(
        val node: ScrollableColumnModel<ScrollableLayoutVariantChildren, LayoutVariantWhenPredicate>,
    ) : LayoutVariantChildren()

    @Serializable
    @SerialName("ScrollableRow")
    data class ScrollableRow(
        val node: ScrollableRowModel<ScrollableLayoutVariantChildren, LayoutVariantWhenPredicate>,
    ) : LayoutVariantChildren()
    ...
    @Serializable
    @SerialName("DataImageCarousel")
    data class DataImageCarousel(val node: DataImageCarouselModel<LayoutVariantWhenPredicate>) : LayoutVariantChildren()
    ...
    data class CreativeResponse(
        val node: CreativeResponseModel<LayoutVariantNonInteractableChildren, LayoutVariantWhenPredicate>,
    ) : LayoutVariantChildren()
    ...
    data class CloseButton(
        val node: CloseButtonModel<LayoutVariantNonInteractableChildren, LayoutVariantWhenPredicate>,
    ) : LayoutVariantChildren()
    ...
    @Serializable
    @SerialName("TimerStateTrigger")
    data class TimerStateTrigger(val node: TimerStateTriggerModel) : LayoutVariantChildren()

    @Serializable
    @SerialName("CatalogStackedCollection")
    data class CatalogStackedCollection(
        val node: CatalogStackedCollectionModel<CatalogStackedCollectionTemplateNode, LayoutVariantWhenPredicate>,
    ) : LayoutVariantChildren()
}
...
sealed class LayoutVariantSchemaModel {
    ...
    @Serializable
    @SerialName("DataImageCarousel")
    data class DataImageCarousel(val node: DataImageCarouselModel<LayoutVariantWhenPredicate>) :
        LayoutVariantSchemaModel()
    ...
    @Serializable
    @SerialName("TimerStateTrigger")
    data class TimerStateTrigger(val node: TimerStateTriggerModel) : LayoutVariantSchemaModel()
...
sealed class ModalChildren {
    ...
    @SerialName("ScrollableColumn")
    data class ScrollableColumn(
        val node: ScrollableColumnModel<ScrollableOuterLayoutChildren, OuterLayoutWhenPredicate>,
    ) : ModalChildren()
    ...
    @Serializable
    @SerialName("ProgressControl")
    data class ProgressControl(
        val node: ProgressControlModel<OuterLayoutNonInteractableChildren, OuterLayoutWhenPredicate>,
    ) : ModalChildren()
    ...
    @SerialName("ToggleButtonStateTrigger")
    data class ToggleButtonStateTrigger(
        val node: ToggleButtonStateTriggerModel<OuterLayoutNonInteractableChildren, OuterLayoutWhenPredicate>,
    ) : ModalChildren()

    @Serializable
    @SerialName("TimerStateTrigger")
    data class TimerStateTrigger(val node: TimerStateTriggerModel) : ModalChildren()
}
...
sealed class OuterLayoutChildren {
    ...
    @Serializable
    @SerialName("TimerStateTrigger")
    data class TimerStateTrigger(val node: TimerStateTriggerModel) : OuterLayoutChildren()
}
...
sealed class OuterLayoutSchemaModel {
    ...
    @Serializable
    @SerialName("TimerStateTrigger")
    data class TimerStateTrigger(val node: TimerStateTriggerModel) : OuterLayoutSchemaModel()
}
...
sealed class ScrollableChildren {
    ...
    @Serializable
    @SerialName("DataImageCarousel")
    data class DataImageCarousel(val node: DataImageCarouselModel<WhenPredicate>) : ScrollableChildren()
    ...
    @SerialName("ToggleButtonStateTrigger")
    data class ToggleButtonStateTrigger(
        val node: ToggleButtonStateTriggerModel<NonInteractableChildren, WhenPredicate>,
    ) : ScrollableChildren()

    @Serializable
    @SerialName("CatalogStackedCollection")
    data class CatalogStackedCollection(
        val node: CatalogStackedCollectionModel<CatalogStackedCollectionTemplateNode, WhenPredicate>,
    ) : ScrollableChildren()

    @Serializable
    @SerialName("CatalogResponseButton")
    data class CatalogResponseButton(
        val node: CatalogResponseButtonModel<LayoutVariantNonInteractableChildren, WhenPredicate>,
    ) : ScrollableChildren()

    @Serializable
    @SerialName("TimerStateTrigger")
    data class TimerStateTrigger(val node: TimerStateTriggerModel) : ScrollableChildren()
}
...
sealed class ScrollableLayoutVariantChildren {
    ...
    @Serializable
    @SerialName("TimerStateTrigger")
    data class TimerStateTrigger(val node: TimerStateTriggerModel) : ScrollableLayoutVariantChildren()
}
...
sealed class ScrollableOuterLayoutChildren {
    ...
    @Serializable
    @SerialName("TimerStateTrigger")
    data class TimerStateTrigger(val node: TimerStateTriggerModel) : ScrollableOuterLayoutChildren()
}
