...
@Serializable
data class EscapeHatchModel<Children>(val data: String)
...
sealed class LayoutVariantChildren {
    ...
    @Serializable
    @SerialName("EscapeHatch")
    data class EscapeHatch(val node: EscapeHatchModel<LayoutVariantChildren>) : LayoutVariantChildren()
}
...
sealed class LayoutVariantSchemaModel {
    ...
    @Serializable
    @SerialName("EscapeHatch")
    data class EscapeHatch(val node: EscapeHatchModel<LayoutVariantChildren>) : LayoutVariantSchemaModel()
}
