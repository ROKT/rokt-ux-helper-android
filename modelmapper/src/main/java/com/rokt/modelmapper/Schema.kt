...
@Serializable
data class AccessibilityGroupedModel<T>(val child: T)
...
@Serializable
data class StatelessStylingBlock<T>(val default: T)
...
data class CreativeResponseModel<Children, Predicates>(
    ...
    val styles:
    LayoutStyle<CreativeResponseElements, ConditionalStyleTransition<CreativeResponseTransitions, Predicates>>? = null,
...
data class DataImageCarouselElements(
    ...
    val indicator: List<BasicStateStylingBlock<DataImageCarouselIndicatorStyles>>,
    ...
    val indicatorWrapper: List<BasicStateStylingBlock<DataImageCarouselIndicatorStyles>>? = null,
)
...
data class DataImageCarouselTransitions(
    ...
    val indicator: List<BasicStateStylingBlock<DataImageCarouselIndicatorStyles>>,
    val active_indicator: List<BasicStateStylingBlock<DataImageCarouselIndicatorStyles>>? = null,
    val seen_indicator: List<BasicStateStylingBlock<DataImageCarouselIndicatorStyles>>? = null,
)
...
data class ScrollableColumnModel<Children, Predicates>(
    val styles:
    LayoutStyle<ScrollableColumnElements, ConditionalStyleTransition<ScrollableColumnTransitions, Predicates>>? = null,
    val children: List<Children>,
)
