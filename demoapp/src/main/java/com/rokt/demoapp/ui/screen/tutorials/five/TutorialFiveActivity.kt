package com.rokt.demoapp.ui.screen.tutorials.five
...
class TutorialFiveActivity : AppCompatActivity() {
                    ...
                    if (content is UiContent.ExperienceContent) {
                        roktLayoutView.loadLayout(
                            ...
                            onPlatformEvent = { platformEvents ->
                                println("RoktEvent: onPlatformEvent received $platformEvents")
                            },
                        )
                    }
                }
    ...
    companion object {
        fun startActivity(context: Context) {
            val intent = Intent(context, TutorialFiveActivity::class.java)
