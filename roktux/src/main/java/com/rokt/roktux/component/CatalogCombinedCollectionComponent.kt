...
internal class CatalogCombinedCollectionComponent(
    private val factory: LayoutUiModelFactory,
    private val modifierFactory: ModifierFactory,
) : ComposableComponent<LayoutSchemaUiModel.CatalogCombinedCollectionUiModel> {

    @Composable
    override fun Render(
        model: LayoutSchemaUiModel.CatalogCombinedCollectionUiModel,
        modifier: Modifier,
        isPressed: Boolean,
        ...
        val activeChildren = model.childrenByCatalogItem[offerState.activeCatalogItemIndex]
            ?: model.childrenByCatalogItem.values.firstOrNull()
            ?: emptyList()
